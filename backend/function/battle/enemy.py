class Enemy:
    ...
    def get_dummy_target(level: int):
        ...
        dummies = {
            ...
            1: Enemy("dummy_1", "1000甲 20抗", 1000000, 1000, 20),
            2: Enemy("dummy_2", "2000甲 40抗", 1000000, 2000, 40),
            3: Enemy("dummy_3", "3000甲 60抗", 1000000, 3000, 60),
            4: Enemy("dummy_4", "4000甲 80抗", 1000000, 4000, 80),
