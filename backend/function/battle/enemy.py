class Enemy:
    ...
    def get_dummy_target(level: int):
        ...
        """
        dummies = {
            0: Enemy("dummy_0", "基础木桩", 1000000, 0, 0),
            1: Enemy("dummy_1", "轻甲木桩", 1000000, 500, 20),
            2: Enemy("dummy_2", "中甲木桩", 1000000, 1000, 40),
            3: Enemy("dummy_3", "重甲木桩", 1000000, 2000, 60),
            4: Enemy("dummy_4", "超重甲木桩", 1000000, 3500, 80),
            5: Enemy("dummy_5", "极限木桩", 1000000, 5000, 100),
